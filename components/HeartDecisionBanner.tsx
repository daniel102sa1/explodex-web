...
export default function HeartDecisionBanner({ symbol }: { symbol: string }) {
  ...
  }, [holding,completed,enter,noEnter,retest,missing,decision?.price_in_entry_zone]);
      ...
      <div className={`overflow-hidden rounded-3xl border shadow-2xl ${tone}`}>
        <div className="grid gap-0 xl:grid-cols-[1.15fr_.85fr]">
          ...
          <div className="border-t border-slate-700/60 bg-slate-950/30 p-4 xl:border-l xl:border-t-0 sm:p-5">
            ...
            <div className="mt-3 text-[10px] leading-5 text-slate-500">Una vez que el Heart dispara ENTRAR, esa activación queda memorizada. El radar puede debilitarse después, pero no vuelve a “falta confirmación” salvo invalidación/cierre.</div>
          </div>
        </div>
      </div>
    </section>
