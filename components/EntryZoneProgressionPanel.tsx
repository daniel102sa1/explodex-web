    ...
    <div className="rounded-3xl border border-cyan-500/15 bg-cyan-500/[.018] p-5">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <div className="mt-1 max-w-3xl text-xs leading-5 text-slate-500">La zona óptima está dentro del plan estructural original. La zona aceptable sigue siendo válida. Si entra en CHASE, ExplodeX espera retest.</div>
        </div>
      ...
      {zone?.available && <div className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
